    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="navbar-menu">
                ...
                <% if (isAdmin) { %>
                <li><a href="admin.jsp" class="navbar-item admin">Admin</a></li>
                <% } %>
            </ul>
        </div>
    </nav>
...
<div class="container admin-content">
    ...
    <h2>Add webnovels</h2>
    <form id="uploadForm" action="addWebnovels" method="post" enctype="multipart/form-data">
        <label for="zipFile">Upload Webnovels Zip File:</label>
        <div class="custom-file-upload" onclick="document.getElementById('zipFile').click()">
            <div class="icon">
            ...
            <input type="file" name="zipFile" id="zipFile" style="display:none;" onchange="document.getElementById('uploadForm').submit()" required>
        </div>
    </form>
